...
var ReactGridLayout = function (_React$Component) {
  ...
  ReactGridLayout.prototype.onDrag = function onDrag(i, x, y, _ref2) {
    ...
    var isRearrangeable = this.props.isRearrangeable;
    var layout = this.state.layout;
    ...
    layout = (0, _utils.moveElement)(layout, l, x, y, true /* isUserAction */, isRearrangeable);
  ...
  ReactGridLayout.prototype.onResize = function onResize(i, w, h, _ref5) {
    ...
    if (!isRearrangeable && (0, _utils.getFirstCollision)(layout, l)) {
      l.w = old.w;
      l.h = old.h;
      return;
    }
...
ReactGridLayout.propTypes = {
  ...
  isRearrangeable: _propTypes2.default.bool,
